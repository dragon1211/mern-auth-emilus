  ...
  return (
    <Suspense fallback={<Loading cover="page"/>}>
      <Switch>
        ...
        <Route path={`${AUTH_PREFIX_PATH}/reset-password`} component={lazy(() => import(`./forgot-password/reset`))} />
        <Route path={`${AUTH_PREFIX_PATH}/verify-email`} component={lazy(() => import(`./verify-email/index`))} />
        <Route path={`${AUTH_PREFIX_PATH}/verify-email/activate`} component={lazy(() => import(`./verify-email/activate`))} />
